...
var catalog = []Fingerprint{
	...
	},
	{
		...
		ActorType:         "crawler",
		RiskScore:         40,
		UserAgentContains: []string{"claudebot", "claude-web", "claude-searchbot", "claude-user", "anthropic-ai"},
	...
	},
	{
		...
		ActorType:         "crawler",
		RiskScore:         40,
		UserAgentContains: []string{"aws-quick-on-behalf-of"},
	},
	{
		ID:                "bytespider",
		Family:            "bytespider",
	...
	},
	{
		...
		ActorType:         "crawler",
		RiskScore:         45,
		UserAgentContains: []string{"cohere-ai", "cohere-training-data-crawler"},
		ASNOrgContains:    []string{"cohere"},
	},
	{
		ID:                "diffbot",
		Family:            "diffbot",
		...
		ActorType:         "crawler",
		RiskScore:         45,
		UserAgentContains: []string{"diffbot"},
		ASNOrgContains:    []string{"diffbot"},
	},
	{
		ID:                "youbot",
		Family:            "youbot",
		...
		ActorType:         "crawler",
		RiskScore:         45,
		UserAgentContains: []string{"youbot"},
		ASNOrgContains:    []string{"you.com", "yext"},
	},
	{
		ID:                "dataforseo",
		Family:            "dataforseo",
		KnownActor:        "DataForSEO",
		ActorType:         "crawler",
		RiskScore:         45,
		UserAgentContains: []string{"dataforseobot"},
		ASNOrgContains:    []string{"dataforseo"},
	},
	{
		ID:                "omgili",
		Family:            "omgili",
		...
		ActorType:         "crawler",
		RiskScore:         45,
		UserAgentContains: []string{"omgili", "omgilibot"},
		ASNOrgContains:    []string{"omgili"},
	},
	{
		ID:                "pingdom",
		Family:            "pingdom",
